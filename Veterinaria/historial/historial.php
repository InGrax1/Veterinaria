...
if (!isset($_SESSION['id_propietario'])) {
    echo "<script>alert('No ha iniciado sesión.'); window.location.href='../login/login.php';</script>";
    exit;
}

$id_propietario = $_SESSION['id_propietario'];

// Tu consulta UNION ALL (sin cambios)
$query = "
    SELECT 
        h.id_historial,
        h.diagnostico,
            ...
            <ul class="nav-menu">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="historial.php">Historial Clínico</a>
...
<main class="page-content">
    <div class="container">
        <h2 class="page-title">Historial de tus Mascotas</h2>
        ...
        <?php else: ?>
            <div class="no-citas-container">
                <img src="data:image/jpeg;base64," 
                    alt="Gato durmiendo" class="no-citas-img">
                <h3>Aún no hay registros</h3>
                <p>No encontramos historial clínico, recetas o vacunas para tus mascotas.</p>
