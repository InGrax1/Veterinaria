...
<head>
    <meta charset="UTF-8">
    <title>Historial Clínico - Patitas Felices</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    <link rel="stylesheet" href="/Veterinaria/Veterinaria/css/histo.css">
    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="no-citas-container">
                ...
                <a href="../propietario/perfil.php" class="btn-primary">Ir a mi Perfil para registrar</a>
            </div>
        <?php endif; ?>
